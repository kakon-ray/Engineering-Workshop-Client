  ...
  return (
    <div>
          ...
          <div className="flex flex-wrap items-center">
            ...
            <div className="grow-0 shrink-0 basis-auto w-full lg:w-6/12 xl:w-8/12">
              <div className="px-6 py-12 md:px-12">
                ...
                <p className="text-accent text-lg pb-2">thisiskakonray@gmail.com</p>
                ...
                <div className="grid lg:gap-x-12 md:grid-cols-3 pt-6">
                  <div className="mb-12 md:mb-0">
                    <h2 className="text-3xl font-bold text-blue-600 mb-4">90%</h2>
                  ...
                  <div className="">
                    <h2 className="text-3xl font-bold text-blue-600 mb-4">50%</h2>
                    <h5 className="text-lg font-medium text-gray-500 mb-0">
                      Back End
                    </h5>
                  </div>
                  <div className="">
                    <h2 className="text-3xl font-bold text-blue-600 mb-4">95%</h2>
                    <h5 className="text-lg font-medium text-gray-500 mb-0">
                      Web Design
                    </h5>
                  </div>
      ...
      <div className="pb-12 mx-40">
        ...
        <div className="w-full bg-accent my-4 py-3 text-metalColor font-bold">
          <div
