        ...
        >
          <div className="flex justify-center items-center h-full">
            <div className="text-center text-white px-6 md:px-12">
              <h1 className="text-3xl md:text-3xl xl:text-4xl font-bold tracking-tight mb-12 uppercase">
                The best offer on the market <br />
                <span>for your business</span>
              </h1>
              <a
                className="inline-block px-7 py-2 mr-1.5 border-2 border-white text-white font-medium text-sm leading-snug uppercase rounded-full shadow-md hover:bg-accent hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out"
